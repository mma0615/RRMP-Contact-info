({
    ...
    //We're calling two separate functions in the helper.js file: one to check if we're in the fall term and one to fetch the user's account ID.
    doInit: function(component, event, helper) {
        component.set("v.isLoading",true);
        helper.setFallTerm(component);
