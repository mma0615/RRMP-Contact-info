            ...
            if(state === 'SUCCESS'){
                ...
                if(userJourneyWrapper.urlFromJourney === false){
                    ...
                    if(userJourneyWrapper.lstUserMilestones !== undefined){
                        ...
                        component.set("v.userMilestones", userJourneyWrapper.lstUserMilestones);
                        if(userJourneyWrapper.mapTasksByMilestoneName !== undefined){
                            var acts = [];
                            for(var key in userJourneyWrapper.mapTasksByMilestoneName){
                                acts.push({value:userJourneyWrapper.mapTasksByMilestoneName[key], key:key});
                    ...
                    component.set("v.journeyMilestoneList", userJourneyWrapper.journeyMilestoneList);
