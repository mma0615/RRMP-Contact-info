({
    ...
    addAvailability: function(component, event, helper) {
        ...
        component.set("v.saveAvailErrMessage", '');
    },
    ...
    confirmAvailability: function(component, event, helper) {
        ...
        helper.deleteAvailability(component, event, helper, selectedConAva);
    ...
    next: function(component, event, helper) {
        ...
        selectDate: function(component, event, helper) {
            ...
            //console.log('current selectedDate'+selectedDateAdd);
    ...
    doInit: function(component, event, helper) {
        ...
        helper.getContactRecord(component, event, helper, contactId);
				...
				*/
				...
				for (let x = firstDayIndex; x > 0; x--) {
        			...
        			$A.createComponent(
							...
							'tag': 'div',
							'body': `${prevLastDay - x + 1}`,
							'HTMLAttributes':{"class":"prev-date"+(pastDate == 1 ? " disable" : ""), 
