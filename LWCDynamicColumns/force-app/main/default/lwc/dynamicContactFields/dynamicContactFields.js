...
import getContacts from '@salesforce/apex/apexContactController.getContactLists';
import getContactFields from '@salesforce/apex/apexContactController.getContactFields';
import getFieldTypes from '@salesforce/apex/apexContactController.getFieldTypes';
        ...
        getFieldTypes({ selectedFields: this.selected })
            .then(result => 
                ...
                this.columns = this.selected.map(field => {
                    ...
                    {
                        return { label: field, fieldName: field, type: 'datetime' };
                    } 
                    else if (dType === 'Integer') 
                    {
                        return { label: field, fieldName: field, type: 'Integer' };
                    } 
